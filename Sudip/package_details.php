        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php else: ?>
                    <li class="nav-item">
                        <a class="nav-link" href="tourists/login.php"><i class="fas fa-sign-in-alt"></i>  Login</a>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="package-summary">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><strong><i class="bi bi-cash-stack"></i> Price:</strong> Rs <?php echo number_format($package['price']); ?></li>
