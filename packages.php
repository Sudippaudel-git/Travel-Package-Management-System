...
<body>
 ...
 <header class="container-fluid">
       <div class="header-top">
            <div class="container">
              ...
              <div class="col-sm-4 d-none d-sm-block contacthd">
                  <p><a href="">TPMS</a> &nbsp;&nbsp; <span>/</span> &nbsp;&nbsp; <span></span> <a href="">HEllo</a></p>
                </div>
                <div class="col-sm-8">

                <ul class="email">
                <a href="register.php" class="btn btn-link">
                              <li> <i class="fa fa-sign-in-alt"></i> Login</li>  
                            </a>
                  </ul>
                ...
                <a href="login.php" class="btn btn-link">
                              <li> <i class="fa fa-user-plus"></i> Create Account</li>  
                            </a>
                  </ul>
                </div>
              </div>
    ...
    <!-- ######## Footer Start Here ####### -->   
     ...
     <div class="copy">
     <div class="container">
            <a href="https://www.smarteyeapps.com/">2024 &copy; All Rights Reserved | Designed and Developed by Sudip Paudel</a>
